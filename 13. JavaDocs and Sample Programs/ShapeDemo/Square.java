...
public class Square extends TwoDShape
{
     ...
     */
    public Square(double len, String colourValue, String shapeType) //Notice there is NO return type for a class constructor.
    {
        super(shapeType, colourValue); // use the constructor in the parent (super class)
        length = len; // set the class attribute (variable) length equal to len
    }
    /**
